...
function convertIfJqueryObject(node) {
...
$(document).ready(function() {
	...
	$('.morph-trigger').on('click', function() {
		...
		if($(this).attr("data-morph-showing") != "true") {

			//	button
			var a = $(this);

			//	target
			var b = $('#' + $(this).attr("data-morph-target"));
		...
		//	TODO: highlight the target

		}

	});

	$('.morph-target .morph-dismiss').on('click', function() {

		//	target
		var b = $(this).closest('.morph-target');
